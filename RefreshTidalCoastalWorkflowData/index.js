...
module.exports = async function (context, message) {
  ...
  async function refresh (transaction, context) {
    failedRows = await executePreparedStatementInTransaction(refreshData, context, transaction, csvUrl, tableName, csvLoadData, partialTableUpdate, rowKeyCheckOverride)
  }
